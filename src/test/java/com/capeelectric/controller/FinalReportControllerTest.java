...
public class FinalReportControllerTest {
	...
	@Test
	public void retrieveAllSites()throws FinalReportException{
	
		logger.info("FinalReportControllerTest retrieveAllSites Function Started");
		List<Site> arrayList =new ArrayList<>();
		when(finalReportServiceImpl.retrieveAllSites("awstesting@rushforsafety.com")).thenReturn(arrayList);
		 ResponseEntity<List<Site>> finalReport = finalReportController.retrieveAllSites("awstesting@rushforsafety.com");
			assertEquals(finalReport.getStatusCode() , HttpStatus.OK);
			logger.info("FinalReportControllerTest retrieveAllSites Function Started");
	}
