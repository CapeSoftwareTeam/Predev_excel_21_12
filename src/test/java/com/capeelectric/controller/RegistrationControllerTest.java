...
//	private RegistrationService awsEmailService;
	...
	@Test
	public void testIsMobileNumberAvailable() throws IOException, MessagingException, RegistrationException {
		logger.info("RegistrationControllerTest testRetrieveAllMobileNumber Started");
		String retrieveAllMobileNumberFromRegister = registrationController.isMobileNumberAvailable("");
		assertNull(retrieveAllMobileNumberFromRegister);
		logger.info("RegistrationControllerTest testRetrieveAllMobileNumber Ended");
	}
