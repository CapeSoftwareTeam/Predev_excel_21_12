...
public class ConsumerUnit implements Serializable {
	...
	private String warningNoticesA;
	
	@Column(name = "WARNING_NOTICEB")
	private String warningNoticesB;
	
	@Column(name = "WARNING_NOTICEC")
	private String warningNoticesC;
	
	@Column(name = "WARNING_NOTICED")
	private String warningNoticesD;
	
	@Column(name = "WARNING_NOTICEE")
	private String warningNoticesE;
	...
	public String getWarningNoticesA() {
		return warningNoticesA;
	}

	public void setWarningNoticesA(String warningNoticesA) {
		this.warningNoticesA = warningNoticesA;
	}

	public String getWarningNoticesB() {
		return warningNoticesB;
	}

	public void setWarningNoticesB(String warningNoticesB) {
		this.warningNoticesB = warningNoticesB;
	}

	public String getWarningNoticesC() {
		return warningNoticesC;
	}

	public void setWarningNoticesC(String warningNoticesC) {
		this.warningNoticesC = warningNoticesC;
	}

	public String getWarningNoticesD() {
		return warningNoticesD;
	}

	public void setWarningNoticesD(String warningNoticesD) {
		this.warningNoticesD = warningNoticesD;
	}

	public String getWarningNoticesE() {
		return warningNoticesE;
	}

	public void setWarningNoticesE(String warningNoticesE) {
		this.warningNoticesE = warningNoticesE;
	}
}
