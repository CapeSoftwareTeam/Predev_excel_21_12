...
public class TestingRecordsSourceSupply implements Serializable {
	...
	@Column(name="SOURCESUPPLY_STATUS")
	private String sourceSupplyStatus;
	
	@Column(name="SUPPLY_ID")
	private Integer supplyId;

	public String getSourceSupplyStatus() {
		return sourceSupplyStatus;
	}

	public void setSourceSupplyStatus(String sourceSupplyStatus) {
		this.sourceSupplyStatus = sourceSupplyStatus;
	}
