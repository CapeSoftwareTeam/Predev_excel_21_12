...
public class TestDistribution implements Serializable {
	...
	@Column(name = "REASON_FOR_VULNARABLE")
	private String reasonForVulnarable;
	...
	public String getReasonForVulnarable() {
		return reasonForVulnarable;
	}

	public void setReasonForVulnarable(String reasonForVulnarable) {
		this.reasonForVulnarable = reasonForVulnarable;
	}
