...
public class IsolationCurrent implements Serializable {
	...
	private IpaoInspection ipaoInspectionIsolation;
	...
	public IpaoInspection getIpaoInspectionIsolation() {
		return ipaoInspectionIsolation;
	}

	public void setIpaoInspectionIsolation(IpaoInspection ipaoInspectionIsolation) {
		this.ipaoInspectionIsolation = ipaoInspectionIsolation;
	}
