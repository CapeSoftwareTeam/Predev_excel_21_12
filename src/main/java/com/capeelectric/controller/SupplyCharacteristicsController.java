...
public class SupplyCharacteristicsController {
	...
	@PostMapping("/lv/addCharacteristics/intsave")
	public ResponseEntity<String> addInternCharacteristics(@RequestBody SupplyCharacteristics supplyCharacteristics)
			throws SupplyCharacteristicsException, DecimalConversionException, CompanyDetailsException {
		logger.debug("called addInternCharacteristics function UserName : {}, SiteId : {}",
				supplyCharacteristics.getUserName(), supplyCharacteristics.getSiteId());
		supplyCharacteristicsService.addInternCharacteristics(supplyCharacteristics);
		logger.debug("Ended addCharacteristics function");
		return new ResponseEntity<String>("SupplyCharacteristics and Earthing Properties Sucessfully Saved",
				HttpStatus.CREATED);
	}
	...
	public ResponseEntity<String> updateCharacteristics(@RequestBody SupplyCharacteristics supplyCharacteristics)
		...
		logger.debug("Ended updateCharacteristics function");
		return new ResponseEntity<String>("SupplyCharacteristics Data successfully Updated", HttpStatus.OK);
	}
	
	@PutMapping("/lv/updateCharacteristics/intsave")
	public ResponseEntity<String> updateInternCharacteristics(@RequestBody SupplyCharacteristics supplyCharacteristics)
			throws SupplyCharacteristicsException, DecimalConversionException, CompanyDetailsException {
		logger.debug("called updateInternCharacteristics function UserName : {},SiteId : {},SupplyCharacteristicsId : {}",
				supplyCharacteristics.getUserName(), supplyCharacteristics.getSiteId(),
				supplyCharacteristics.getSupplyCharacteristicsId());
		supplyCharacteristicsService.updateInternCharacteristics(supplyCharacteristics);
		logger.debug("Ended updateInternCharacteristics function");
		return new ResponseEntity<String>("SupplyCharacteristics Data successfully Updated", HttpStatus.OK);
	}
