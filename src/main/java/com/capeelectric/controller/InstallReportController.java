...
public class InstallReportController {
	...
	@PostMapping("/lv/addInstalReport/intsave")
	public ResponseEntity<String> addInternInstallationReport(@RequestBody ReportDetails reportDetails)
			throws InstalReportException, CompanyDetailsException {
		logger.info("called addInternInstallationReport function UserName : {}, SiteId", reportDetails.getUserName(),
				reportDetails.getSiteId());
		instalReportService.addInternInstallationReport(reportDetails);
		return new ResponseEntity<String>("Basic Information Successfully Saved", HttpStatus.CREATED);
	}
	...
	@PutMapping("/lv/updateInstalReport/intsave")
	public ResponseEntity<String> updateInternInstallationReport(@RequestBody ReportDetails reportDetails)
			throws InstalReportException, CompanyDetailsException {
		logger.info("called updateInternInstallationReport function UserName : {},SiteId : {},ReportId : {}", reportDetails.getUserName(),
				reportDetails.getSiteId(),reportDetails.getReportId());
		instalReportService.updateInternInstallationReport(reportDetails);
