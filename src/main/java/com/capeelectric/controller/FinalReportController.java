...
public class FinalReportController {
	...
	@GetMapping("/lv/retrieveAllSites/{userName}")
	public ResponseEntity<List<Site>> retrieveAllSites(@PathVariable String userName) throws FinalReportException{
		logger.info("FinalReportAPI_started retrieveAllSites");
			
		return new ResponseEntity<List<Site>>(finalReportServiceImpl.retrieveAllSites(userName),
						HttpStatus.OK);
	}
