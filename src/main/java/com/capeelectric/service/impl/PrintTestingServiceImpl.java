...
//				TestingReport testingRepo = testingReportRepository.findByUserNameAndSiteId(userName, siteId);
				...
				TestingReportComment comments = null;
				if(reportComments.size() !=0) {
					 comments = reportComments.get(0);
				}
				...
				for (Testing testing1 : testing) {
					if (testing1.getTestingStatus()!=null&&!testing1.getTestingStatus().equalsIgnoreCase("R")) {
						List<TestDistRecords> testDistRecords = testing1.getTestDistRecords();
						testingIteration(document, testing1, testDistRecords, testEquipment);
						for (TestDistRecords testDistRecord : testDistRecords)
						   if(testDistRecord.getTestDistRecordStatus()!=null&&!testDistRecord.getTestDistRecordStatus().equalsIgnoreCase("R")) {
				...
				if (comments !=null && comments.getViewerUserName() != null && comments.getInspectorUserName() != null) {
					document.newPage();
	...
	private void testingIteration(Document document, Testing testing1, List<TestDistRecords> testDistRecord,
		...
		for (TestDistRecords testDistRecords1 : testDistRecord) {
			if (testDistRecords1.getTestDistRecordStatus() != null
					&& !testDistRecords1.getTestDistRecordStatus().equalsIgnoreCase("R")) {
				List<TestDistribution> testDistribution = testDistRecords1.getTestDistribution();
				List<TestingRecords> testRecords = testDistRecords1.getTestingRecords();
				...
				for (TestDistribution distribution : testDistribution) {
					PdfPCell cell13 = new PdfPCell(new Paragraph(distribution.getReferance(), font5));
					table1.addCell(new Phrase("Distribution board name:", font5));
					cell13.setBorder(PdfPCell.NO_BORDER);
					table1.addCell(cell13);

					PdfPCell cell14 = new PdfPCell(new Paragraph("Location:", font5));
					cell14.setBorder(PdfPCell.NO_BORDER);
					cell14.setGrayFill(0.92f);
					table1.addCell(cell14);
					PdfPCell cell28 = new PdfPCell(new Paragraph(distribution.getLocation(), font5));
					cell28.setGrayFill(0.92f);
					cell28.setBorder(PdfPCell.NO_BORDER);
					table1.addCell(cell28);

					PdfPCell cell15 = new PdfPCell(new Paragraph(distribution.getDistributionBoardDetails(), font5));
					table1.addCell(new Phrase("Source Details:", font5));
					...
					PdfPCell cell18 = new PdfPCell(
							new Paragraph(distribution.getInstalledEquipmentVulnarable(), font5));
					table1.addCell(new Phrase("Installed equipment vulnarable to testing:", font5));
					cell18.setBorder(PdfPCell.NO_BORDER);
					table1.addCell(cell18);

					PdfPCell cell20 = new PdfPCell(new Paragraph(distribution.getReasonForVulnarable(), font5));
					table1.addCell(new Phrase("Reason for vulnarable areas:", font5));
				...
				for (TestIncomingDistribution testincomingDist : testIncomingDistribution) {
					List<TestDistribution> testDistribution22 = testDistRecords1.getTestDistribution();
					...
					if (testincomingDist.getSourceFromSupply().equals(distribution.getSourceFromSupply())) {
						...
						addRow(table2, "External Loop Impedance Ze (ohms)", ZS1, ZS2, ZS3, ZS4, ZS5, ZS6, ZS7, ZS8,
								ZS9);
						addRow(table2, "Prospective fault current Ipfc (kA)", IPF1, IPF2, IPF3, IPF4, IPF5, IPF6, IPF7,
								IPF8, IPF9);
				...
				for (TestingRecords testingRecords11 : testRecords) {
					if (testingRecords11.getTestingRecordStatus()!=null&&!testingRecords11.getTestingRecordStatus().equalsIgnoreCase("R")) {
	...
	private void tableData1(PdfPTable table11, List<TestingEquipment> testEquipment)
		...
		for (TestingEquipment arr : testEquipment) {
			if (arr.getTestingEquipmentStatus()!=null&&!arr.getTestingEquipmentStatus().equalsIgnoreCase("R")) {
				PdfPCell cell = new PdfPCell();
...
//				split(" ")[0]
	...
	private void testingTableIteration(Document document, TestingRecords testingRecords1)
		...
		cell1 = new PdfPCell(new Phrase("Scope/Status", font23));
		cell1.setGrayFill(0.92f);
		cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table466.addCell(cell1);
		cell1 = new PdfPCell(new Phrase(testingRecords1.getCircuitDrop(), font27));
		cell1.setColspan(2);
		cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table466.addCell(cell1);
		...
		cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table466.addCell(cell1);
		cell1 = new PdfPCell(new Phrase(testingRecords1.getConductorDrop(), font27));
		cell1.setColspan(9);
		cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table466.addCell(cell1);
		...
		cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table466.addCell(cell1);
		cell1 = new PdfPCell(new Phrase(testingRecords1.getConductorResistanceDrop(), font27));
		cell1.setColspan(9);
		cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table466.addCell(cell1);
		...
		cell1 = new PdfPCell(new Phrase("Scope/Status", font26));
		cell1.setGrayFill(0.92f);
		cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table466.addCell(cell1);
		...
		cell1 = new PdfPCell(new Phrase(testingRecords1.getInsulationDrop(), font23));
		cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table466.addCell(cell1);
		...
		cell1 = new PdfPCell(new Phrase(testingRecords1.getVoltageDrop(), font23));
		cell1.setHorizontalAlignment(Element.ALIGN_CENTER);
		table466.addCell(cell1);
