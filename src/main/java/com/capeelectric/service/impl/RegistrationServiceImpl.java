...
//	}
	...
	*/
	...
	@Override
	public String isMobileNumberAvailable(String mobileNumber)throws RegistrationException {
		Optional<Register> isMobileNumberavailableFromDb=registerRepository.findByContactNumber(mobileNumber);
		return isMobileNumberavailableFromDb.isPresent() ? isMobileNumberavailableFromDb.get().getContactNumber(): "this number not in data base";
	}
