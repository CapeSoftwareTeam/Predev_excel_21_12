...
CREATE TABLE isolation_current_table (       
			...
			CONSTRAINT FK_ISOLATION_IPAO_INSPECTION_ID  FOREIGN KEY (IPAO_INSPECTION_ID) REFERENCES ins_ipao_inspection_table(IPAO_INSPECTION_ID) ON DELETE CASCADE
...
CREATE TABLE inspection_outer_observation_table(
		   ...
		   CONSTRAINT FK_OUTER_IPAO_INSPECTION_ID  FOREIGN KEY (IPAO_INSPECTION_ID) REFERENCES ins_ipao_inspection_table(IPAO_INSPECTION_ID) ON DELETE CASCADE

);

 CREATE TABLE ins_inspection_outer_observation_table(
		   ...
		   INSPECTION_OUTER_OBSERVATION_STATUS VARCHAR(225),
		   CONSTRAINT PK_INSPECTION_OUTER_OBSERVATION_ID PRIMARY KEY(INSPECTION_OUTER_OBSERVATION_ID),
		   CONSTRAINT FK_INS_OUTER_IPAO_INSPECTION_ID  FOREIGN KEY (IPAO_INSPECTION_ID) REFERENCES ins_ipao_inspection_table(IPAO_INSPECTION_ID) ON DELETE CASCADE

);

CREATE TABLE ins_inspection_inner_observation_table(
...
CREATE TABLE ins_db_child_observation (DB_CHILD_OBSERVATION_ID INTEGER NOT NULL, 
                                   COMMENT VARCHAR(255), 
								   FURTHER_ACTIONS VARCHAR(255),
